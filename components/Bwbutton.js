...
function Bwbutton({buttonProp}){
    let finalProps = {
        ...
        refFromParent: buttonProp.parentRef || null
    }
    return <a ref={finalProps.refFromParent} href={buttonProp.link}><div onClick={finalProps.onClickFunction} className={style.bwbutton1}>
